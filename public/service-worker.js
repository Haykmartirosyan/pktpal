...
/* harmony export */   "cacheWrapper": () => (/* reexport safe */ _private_cacheWrapper_js__WEBPACK_IMPORTED_MODULE_2__.cacheWrapper),
...
/* harmony export */   "fetchWrapper": () => (/* reexport safe */ _private_fetchWrapper_js__WEBPACK_IMPORTED_MODULE_10__.fetchWrapper),
/* harmony export */   "getFriendlyURL": () => (/* reexport safe */ _private_getFriendlyURL_js__WEBPACK_IMPORTED_MODULE_11__.getFriendlyURL),
/* harmony export */   "logger": () => (/* reexport safe */ _private_logger_js__WEBPACK_IMPORTED_MODULE_12__.logger),
/* harmony export */   "resultingClientExists": () => (/* reexport safe */ _private_resultingClientExists_js__WEBPACK_IMPORTED_MODULE_13__.resultingClientExists),
/* harmony export */   "timeout": () => (/* reexport safe */ _private_timeout_js__WEBPACK_IMPORTED_MODULE_14__.timeout),
...
(0,workbox_core__WEBPACK_IMPORTED_MODULE_0__.clientsClaim)(); // Precache all of the assets generated by your build process.
// Their URLs are injected into the manifest variable below.
// This variable must be present somewhere in your service worker file,
// even if you decide not to use precaching. See https://cra.link/PWA

var revision = Date.now().toString().slice(-6);
(0,workbox_precaching__WEBPACK_IMPORTED_MODULE_2__.precacheAndRoute)([{
  url: '/',
  revision: revision
}, {
  url: '/js/app.js',
...
/*registerRoute(
  ...
  createHandlerBoundToURL(process.env.MIX_PUBLIC_URL)
);*/
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_3__.registerRoute)(function (_ref) {
  var url = _ref.url;
  return true;
}, new workbox_strategies__WEBPACK_IMPORTED_MODULE_4__.NetworkOnly()); // This allows the web app to trigger skipWaiting via
