...
return [
    ...
    */
    ...
    'events_connection' => env('EVENTS_CONNECTION'),
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options'        => array(
                ...
                PDO::MYSQL_ATTR_SSL_CA                 => '/etc/ssl/wpengine_root_ca.pem',
            ),
        ],
        ...
        'clickhouse-old' => [
            'driver'   => 'clickhouse',
            'host'     => env('CLICKHOUSE_OLD_DB_HOST', ''),
            'database' => env('CLICKHOUSE_OLD_DB_DATABASE', ''),
            'port'     => env('CLICKHOUSE_OLD_DB_PORT', ''),
            'username' => env('CLICKHOUSE_OLD_DB_USERNAME', ''),
            'password' => env('CLICKHOUSE_OLD_DB_PASSWORD', ''),
            'options'  => [
                'timeout'  => 10,
                'protocol' => 'http'
            ]
