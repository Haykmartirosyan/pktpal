...
class DevicePaired extends Component {
    constructor(props) {
        super(props);
        this.state = {}
    }
    ...
    render() {
        return (
            <div>
                <div className="modal fade" id="devicePaired" tabIndex="-1" role="dialog"
                            ...
                            <div className="modal-body">
                                ...
                                <div className="container mt-5">
                                    <div className={'row'}>
                                        ...
                                        <div className={'col-12 d-flex justify-content-center'}>
                                            <div className={'mt-3'}>
                                                <h2 className={'font-weight-bold'}>Pairing success</h2>
                                            </div>
                                        </div>
                                        ...
                                        <div className={'col-12 d-flex justify-content-center'}>
                                            <div className={'mt-3 text-center'}>
                                                <p>
                                                    Congratulations! You’ve paired your device with your PKT Cube
                                                </p>
                                            </div>
                                        </div>
