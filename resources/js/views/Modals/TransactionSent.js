...
class TransactionSent extends Component {
    ...
    render() {
        return (
            <div>
                <div className="modal fade" id="TransactionSentModal" tabIndex="-1" role="dialog"
                            ...
                            <div className="modal-body">
                                ...
                                <div className="container mt-5">
                                    <div className={'row'}>
                                        ...
                                        <div className={'col-12 d-flex justify-content-center'}>
                                            <div className={'mt-3'}>
                                                <h1>{this.props.amount} PKT Sent</h1>
                                            </div>
                                        </div>
                                        ...
                                        <div className={'col-12 d-flex justify-content-center'}>
                                            <div className={'mt-3 text-center'}>
                                                <p className={'mb-0'}>
                                                    You have sent PKT to
                                                </p>
                                                <p>
                                                   <b className={`text-break`}> {this.props.to}</b>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className={'col-12 d-flex justify-content-center'}>
                                            <div className={'mt-3 text-center'}>
                                                ...
                                                <p>
                                                    <b className={`text-break`}> {this.state.transactionId}</b>
                                                </p>
